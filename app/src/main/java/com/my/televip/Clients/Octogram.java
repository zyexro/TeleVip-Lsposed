...
public class Octogram {
    ...
    static {
        // Octogram 3.5.1 (Telegram 11.x) Mappings
        ...
        classList.add(new ClassInfo("org.telegram.ui.SettingsActivity", "org.telegram.ui.SettingsActivity"));
        ...
        // Method mappings
        methodList.add(new MethodInfo("org.telegram.messenger.UserConfig", "isPremium", "isPremium"));
        methodList.add(new MethodInfo("SettingsActivity", "fillItems", "fillItems"));
        methodList.add(new MethodInfo("SettingsActivity", "onClick", "onClick"));
        methodList.add(new MethodInfo("DrawerLayoutAdapter", "resetItems", "resetItems"));
        methodList.add(new MethodInfo("LaunchActivity", "onCreate", "onCreate"));
        ...
        ParameterResolver.register("para5",new Class[]{int.class});
    ...
    public static class loadParameter implements LoaderParameter {
        ...
        public void loadParameter7() {
                ...
                ParameterResolver.register("7", new Class[]{com.my.televip.loadClass.getMessageObjectClass(), photoViewerproviderClass, java.lang.Runnable.class, java.lang.Runnable.class});
        }
        ...
        public void loadParameter10() {
            ...
            ParameterResolver.register("10", new Class[]{java.util.ArrayList.class,UniversalAdapterClass});
        }
